        ...
        <div>
          ...
          <div class="relative">
            <input
              ...
              disabled={loading}
              class="input font-mono disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              <div class="absolute top-full left-0 right-0 mt-1 max-h-48 overflow-y-auto rounded-lg border border-border bg-card shadow-lg z-10">
                ...
                {#if shouldShowCreate}
                  <button
                    ...
                    class="dropdown-item text-primary border-t border-border"
                  >

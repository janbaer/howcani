...
## Purpose
Allows users to restore their data by uploading a previously exported backup file via the Settings page. Supports cross-user and cross-instance imports, optional pre-clear of existing data, and timestamp preservation.
## Requirements
